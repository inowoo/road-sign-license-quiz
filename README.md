...
実写表示にはGoogle Maps Embed APIを使用します。各チェックポイントへ進むと、JSONに保存した地上車道の `streetViewLocation` と向きに応じてStreet Viewが切り替わります。論理上の地点とパノラマ検索地点を分離し、地下駅や施設内の画像へ吸着しにくい構成にしています。地点・進行データはプロトタイプ用です。
...
```json
{
  ...
  "start": {
    ...
    "lat": 35.0106,
    "lng": 135.7597,
    "streetViewLocation": { "lat": 35.00905, "lng": 135.75965 },
    "heading": 180
  },
  "end": {
    "name": "京都駅前・塩小路通",
    "lat": 34.9858,
    "lng": 135.7588,
    "streetViewLocation": { "lat": 34.987243, "lng": 135.761087 },
    "heading": 270
  },
...
```json
{
  ...
  "streetViewLocation": { "lat": 35.00495, "lng": 135.75965 },
  "heading": 180,
